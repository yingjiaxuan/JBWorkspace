...
# ******************以上脚本完成视图生成并拷贝入excel*************************
# ******************以下为语句留档*****************
# sql = 'select * from REFERENCE where ROWNUM <= 10'
# sql = "select * from REFERENCE where HCP_NAME LIKE '%赵春贺%' "

# username = "cn_cdm_dw"
# pwd = "lQFV52-2"
# dsn = cx_Oracle.makedsn('199.28.178.41', '1521', 'ORACLEDW')
#
# username_tst = "CN_CDM_TST"
# pwd_tst = "q12wsxza"
# dsn_tst = cx_Oracle.makedsn('SGHSD001.corpnet2.com', '1521', 'CNTST002')
